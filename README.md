...
2. 将 `main.js`、`manifest.json` 和 `styles.css` 复制到你的 vault 的 `.obsidian/plugins/embedded-note-titles/` 文件夹中
3. 重新加载 Obsidian
4. 在设置 → 第三方插件中启用 "Embedded Note Titles"
